...
function questionCreate(title, text, tags, answers, asked_by, ask_date_time, views,latestActivity) {
  qstndetail = {
    title: title,
    text: text,
    tags: tags,
...
const populate = async () => {
  ...
  [t1, t2], [a4, a5], 'JoJi John', new Date('December 17, 2020 03:24:00'), 10,new Date('December 31, 2022 20:20:59'));
  ...
  [t3, t4, t2], [a3, a1, a2], 'saltyPeter', new Date('January 01, 2022 21:06:12'), 121,new Date('April 21, 2022 15:25:22'));
